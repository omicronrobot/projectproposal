# Contributing to Omicron projectproposal

The following is a set of guidelines to contribute to Omicron projectproposal Board and its repositories, which are hosted on the [omicronrobot Organization](https://github.com/omicronrobot) on GitHub.
...
Before raising a new issue, check [our issue list](https://github.com/omicronrobot/projectproposal/issues) to determine if it already contains the problem that you are facing.
...
```bash
git clone https://github.com/<your-username>/projectproposal.git
cd projectproposal
git remote add upstream https://github.com/omicronrobot/projectproposal.git
```
